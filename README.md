...
<p align="center">
  ...
  <a href="https://github.com/zylyes/TracePipeline/releases"><img src="https://img.shields.io/badge/version-4.3.3-brightgreen" alt="Version"></a>
...
| 版本   | 日期    | 里程碑                                                                  |
| :----- | :------ | :---------------------------------------------------------------------- |
| 未发布 | 2026-06 | 即时性能与稳定性修复：图片查看器事件泄漏、进度条 RAF 空转、Pillow 缩略图兼容 |
| v4.3.3 | 2026-06 | 死代码清理与接口精简：6 项清理，删除约 112 行代码，无功能变更           |
