...
后续我预计不会再持续投入这个项目；如果遇到问题或有功能需求，可以通过 GitHub Issue 或邮箱（2965090785@qq.com）联系我。
...
- 这是最后一个计划内维护版本。项目仍保留开源代码与发行产物，后续问题或功能需求请通过 GitHub Issue 或邮箱（2965090785@qq.com）反馈。
