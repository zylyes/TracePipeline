...
- [6. 功能使用说明](#-6-功能使用说明)
  ...
  - [6.5 打包分发](#65-打包分发)
- [7. 算法原理](#-7-算法原理)
  - [7.1 综合法测量原理](#71-综合法测量原理)
  - [7.2 复平面端点坐标算法](#72-复平面端点坐标算法)
  - [7.3 坐标变换流水线](#73-坐标变换流水线)
  - [7.4 统计指标定义](#74-统计指标定义)
  - [7.5 圆形取样窗策略](#75-圆形取样窗策略)
  - [7.6 节点拓扑识别](#76-节点拓扑识别)
- [8. 项目目录结构](#-8-项目目录结构)
- [9. 开发指南](#-9-开发指南)
  - [9.1 开发环境搭建](#91-开发环境搭建)
  - [9.2 代码质量工具](#92-代码质量工具)
  - [9.3 贡献流程](#93-贡献流程)
...
# source .venv/bin/activate     # Linux/macOS (CLI-only)
